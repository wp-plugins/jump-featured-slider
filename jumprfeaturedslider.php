...
function wp_jump_featured() {
	...
	$html .= '<div style="overflow:hidden;padding-top:4px;" id="sortjumpsort">'.((isset($img['url'])?'<img src="'.$img['url'].'" width="110px" style="float:left;margin-right:10px;">':'<img src="'.WP_PLUGIN_URL.'/jumprfeaturedslider/assets/nocover.jpg" width="110px" height="110px" style="float:left;margin-right:10px;">')).'
